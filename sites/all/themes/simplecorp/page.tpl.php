            ...
            <div id="pre-header" class="clearfix">
                ...
                <?php if (theme_get_setting('social_icons_display','simplecorp')): ?>   
                    ...
                    <div id="social-icons" class="clearfix">
                        <ul id="social-links">
                            <li class="facebook-link"><a href="https://www.facebook.com/talendexchange" class="facebook" id="social-01" title="Join Us on Facebook!">Facebook</a></li>
                            <li class="twitter-link"><a href="https://twitter.com/dhiraj_bharti" class="twitter" id="social-02" title="Follow Us on Twitter">Twitter</a></li>
                            <li class="google-link"><a href="https://plus.google.com/u/0/+dhirajbharti" id="social-03" title="Google" class="google">Google</a></li>
							<li class="linkedin-link"><a href="https://uk.linkedin.com/in/dharmendra1983" id="social-07" title="Linkedin" class="linkedin">Linkedin</a></li>
							<li class="rss-link"><a href="../blogs.xml" target="_blank" id="social-08" title="RSS" class="rss">RSS Feeds</a></li>
            ...
            <div id="featured"> 
                ...
                <?php if (theme_get_setting('highlighted_display','simplecorp')): ?>
                    ...
                    <div class="container clearfix">
                        ...
                        <!--featured-item -->
                        <div class="one-half"> <?php print render($page['one_half']); ?> </div>
                        <!--EOF: featured-item -->


                        <!--featured-item -->
                        <div class="one-half last">
						<?php print render($page['one_half_last']); ?> </div>
                        <!--EOF: featured-item -->              
    
                    </div> 

                    <div class="container clearfix"><div class="horizontal-line"> </div>
        ...
        <footer id="footer">
            ...
            <div id="footer-bottom">
                <div class="container clearfix">
                    ...
                    <div class="credits">
                    Developed by <a href="http://www.talendexchange.com">Talend|Exchange</a>
                    </div>
